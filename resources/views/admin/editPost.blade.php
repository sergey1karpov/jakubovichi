...
@section('content')
    ...
    <form action="{{route('home.update', ['id' => $post->id])}}" method="POST" style="width: 500px; margin: 30%" class="mt-3 text-center" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        ...
        <button type="submit" class="btn btn-primary">Редачить</button>
    </form>
